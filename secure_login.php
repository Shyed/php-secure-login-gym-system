...
$user_id_auth = ltrim($_POST['uname']);
$user_id_auth = rtrim($user_id_auth);

$pass_key = ltrim($_POST['psw']);
$pass_key = rtrim($_POST['psw']);
...
$sql          = "SELECT * FROM admin WHERE admin_uname='$user_id_auth' and admin_pass='$pass_key'";
